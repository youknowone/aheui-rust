...
fn test_hello_cranelift() {
    let source = std::fs::read_to_string(
        "/Users/al03219714/Projects/pypy/rpaheui/snippets/hello-world/hello.puzzlet.aheui",
    )
    .unwrap();
...
fn test_queue_cranelift() {
    ...
    let source = std::fs::read_to_string(
        "/Users/al03219714/Projects/pypy/rpaheui/snippets/standard/queue.aheui",
    )
    .unwrap();
    let (out, _exit, compile_ms) = run_cranelift(&source);
...
fn test_99bottles_cranelift() {
    let source = std::fs::read_to_string(
        "/Users/al03219714/Projects/pypy/rpaheui/snippets/99bottles/99bottles.aheui",
    )
    .unwrap();
...
fn test_aheui_interp_cranelift() {
    let source = std::fs::read_to_string(
        "/Users/al03219714/Projects/pypy-compaheuiler/aheui/tests/aheui.aheui",
    )
    .unwrap();
